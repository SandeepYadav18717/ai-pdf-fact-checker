 ...
 * @returns The `PDF_READER` component is being returned. It contains JSX elements for a PDF Fact Checker interface, including an input for uploading a PDF file, a button to trigger the fact-checking process, display areas for total truth and false counts, and a section to show the backend result.
 */
